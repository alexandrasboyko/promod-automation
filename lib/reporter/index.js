...
const {attachFailedApplicationConditionAllure} = require('./allure')
const {attachFailedApplicationConditionConsole} = require('./console')
...
async function attachFailedApplicationCondition(title) {
  const {allure} = require('allure-mocha/runtime')
  console.log(allure, '(((((((((((((((((((((((((((((')
  if(allure) {
...
module.exports = {
  step,
  decorateBase,
  attachFailedApplicationCondition
}